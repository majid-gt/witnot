# core/scripts/load_questions.py

import os
import django

os.environ.setdefault("DJANGO_SETTINGS_MODULE", "misstantra.settings")
django.setup()

from core.models import Question

# Your original tuple data (easy to copy-paste)
raw_questions = [
...
# ✅ Convert raw tuples to dict with correct_answer as 'A','B','C','D'
import random
from core.models import Question
...
for q in raw_questions:
    ...
    try:
        correct_index = options.index(correct_text.strip())
    except ValueError:
        # If correct_text not in options for some reason, pick random
        correct_index = random.randint(0, 3)
        print(f"⚠️ Random correct option used for question: {text}")
...
print("✅ All questions added successfully with shuffled options!")
